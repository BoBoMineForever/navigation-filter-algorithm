...
%                           程序设计：熊智  日期：2002/8/9
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [UKFTraceData,UKFIMUData,UKFSinsData,UKFKALData,UKFErrData,UKFGPSData]=sf_ukfm_sins_gps(t_stop);
%%%%%%%%常数设置%%%%%%%%%%%
...
%   data_loop=data_loop+1;
  ...
  if( (0.99<T_M)&(T_M<1.01)  )  
      ...
      tic;
      [Xu,PKU,UKFXerr]=sf_ukf_gps(t,T_D,Fb,Wibb,attiN,veloN,posiN,posiG,veloG,Xu,PKU,UKFXerr,kflag);
...
% %%%%%%%%%%%%%存储仿真数据%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
save ukftrace_q.dat UKFTraceData -ASCII;    %存储航迹数据
save ukfimu_q.dat   UKFIMUData   -ASCII;    %存储仿真产生的IMU数据
save ukfsins_q.dat  UKFSinsData  -ASCII;    %存储导航输出数据
save ukfkal_q.dat   UKFKALData   -ASCII;    %存储卡尔曼滤波些方差阵
save ukferr_q.dat   UKFErrData   -ASCII;    %存储卡尔曼滤波估计的误差修正值
