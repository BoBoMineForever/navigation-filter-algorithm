...
%                           程序设计：熊智  日期：2002/8/9
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function [UKFSinsData]=ukfm_sins_gps
function [UKFTraceData,UKFIMUData,UKFSinsData,UKFKALData,UKFErrData,UKFGPSData]=shuaijianukfm_sins_gps(t_stop);
%%%%%%%%常数设置%%%%%%%%%%%
...
%   data_loop=data_loop+1;
  ...
  if( (0.99<T_M)&(T_M<1.01)  )  
      ...
      tic;
      %shuaijianjiyilvbo
      [Xu,PKU,UKFXerr]=shuaijianukf_gps(t,T_D,Fb,Wibb,attiN,veloN,posiN,posiG,veloG,Xu,PKU,UKFXerr,kflag);
%         [Xu,PKU,UKFXerr]=ukf_gps_LU(t,T_D,Fb,attiN,veloN,posiN,posiG,veloG,Wibb,Xu,PKU,UKFXerr,kflag);
...
%%%%%%%%%%%%%存储仿真数据%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
save ukftrace_f.dat UKFTraceData -ASCII;    %存储航迹数据
save ukfimu_f.dat   UKFIMUData   -ASCII;    %存储仿真产生的IMU数据
save ukfsins_f.dat  UKFSinsData  -ASCII;    %存储导航输出数据
save ukfkal_f.dat   UKFKALData   -ASCII;    %存储卡尔曼滤波些方差阵
save ukferr_f.dat   UKFErrData   -ASCII;    %存储卡尔曼滤波估计的误差修正值
