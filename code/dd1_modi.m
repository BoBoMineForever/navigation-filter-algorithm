...
function [attiN,veloN,posiN]=dd1_modi(attiN,veloN,posiN,Xd)



  veloN(1,1) = veloN(1,1)-Xd(1,1);  % m/s
  veloN(2,1) = veloN(2,1)-Xd(2,1);
  veloN(3,1) = veloN(3,1)-Xd(3,1);  
    %飞行器速度修正

  posiN(1,1) = posiN(1,1) - Xd(9,1)*180.0/pi; % deg
  posiN(2,1) = posiN(2,1) - Xd(8,1)*180.0/pi; % deg
  posiN(3,1) = posiN(3,1) - Xd(10,1);          % m
    %飞行器位置修正
