...
function [Xc,PK,Xerr]=kalm_gps_init(posiN,Xc,PK,Xerr)
  ...
  Rn=Re*(1+f*sin(lati)*sin(lati));
    ...
    Xerr0=[150.0*pi/(3600.0*180.0),150.0*pi/(3600.0*180.0),300.0*pi/(3600.0*180.0),0.6,0.6,0.6,50.0/(Rm+heig),50.0/(Rn+heig)/cos(lati),50.0, ...
